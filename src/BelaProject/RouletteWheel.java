...
public class RouletteWheel {
    ...
    public RouletteWheel() {
        ...
        numbers.add(new RouletteNumber(Integer.parseInt(parts[0]), BetOption._GREEN));
        
        
        for (int i = 1; i < parts.length; i++) {
            if (i%2==0) {
                numbers.add(new RouletteNumber(Integer.parseInt(parts[i]), BetOption._BLACK));
            } else{
                numbers.add(new RouletteNumber(Integer.parseInt(parts[i]), BetOption._RED));
            }
